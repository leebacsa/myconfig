...
ZSH_THEME_GIT_PROMPT_DIRTY="($red✘$purple)"
ZSH_THEME_GIT_PROMPT_CLEAN="($green✔$purple)"
...
ZSH_THEME_GIT_PROMPT_AHEAD_REMOTE="$silver↑"
ZSH_THEME_GIT_PROMPT_BEHIND_REMOTE="$silver↓"
